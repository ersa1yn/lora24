...
private:
    ...
    ControlPacket waitTurn();
    ControlPacket getConfiguration(ControlPacket rx);
    void setConfiguration(ControlPacket rx);
    uint8_t rangingRssi();
    void rangingMaster(ControlPacket rx);
    void rangingSlave(ControlPacket rx);
    void passTurn(ControlPacket rx);
    bool dataSend(ControlPacket rx);
