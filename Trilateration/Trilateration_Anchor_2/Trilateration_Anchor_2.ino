...
sweepCount: number of ranging sweeps done, multiply by 40 for total ranging

CHN_ID: 40 channels corresponding to BLE channels; check "rangingCorrection.h"
...
const uint8_t DEVICE_ID = 0x02; // master counted forwards
const uint8_t TARGET_ID = 0xff; // slave counted backwards
const char*   DEVICE_NAME = "feather-master-02"; // Unique per device
